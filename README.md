...
![Animated GIF of running the script below to add this repo as a submodule to a new Hugo site and then deploy it.](/images/example2.gif)
...
![An example of an HTML comment, telling you that the HTML code rendered below was templated by the file stored in `themes/hugo-plain-themes/layouts/index.html`.](/images/example-comment.gif)
